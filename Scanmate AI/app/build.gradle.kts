...
val versionCodeOverride = (System.getenv("VERSION_CODE") ?: providers.gradleProperty("VERSION_CODE").orElse("2").get()).toInt()
val versionNameOverride = System.getenv("VERSION_NAME") ?: providers.gradleProperty("VERSION_NAME").orElse("1.1.0-colab-ready").get()
...
android {
    ...
    defaultConfig {
        applicationId = "com.aistudio.scanmate.abcdrf"
        minSdk = 24
